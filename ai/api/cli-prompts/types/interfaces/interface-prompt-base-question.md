---
title: PromptBaseQuestion from @tsed/cli-prompts
description: api documentation of PromptBaseQuestion from @tsed/cli-prompts
meta:
 - name: keywords
   description: api typescript node.js documentation PromptBaseQuestion interface
---
# PromptBaseQuestion - @tsed/cli-prompts
