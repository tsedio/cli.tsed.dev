---
title: EslintInitHook from @tsed/cli-plugin-eslint
description: api documentation of EslintInitHook from @tsed/cli-plugin-eslint
meta:
 - name: keywords
   description: api typescript node.js documentation EslintInitHook class
---
# EslintInitHook - @tsed/cli-plugin-eslint
