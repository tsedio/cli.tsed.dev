...
If you want to ship an MCP server with your CLI distribution, add an entrypoint (for example via [command](/ai/api/cli-core/types/fn/function-command.md)) that calls `mcpServerConnect()`. You can stick with decorators or the functional helper:
